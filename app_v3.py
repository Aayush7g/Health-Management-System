...
TWITTER_API_KEY = 'SPKgXIELGJox0MAgaEBdZvGJT'
TWITTER_API_SECRET = 'ex1BTKY8Xuv6R97q44JA1AVATvo602wp6SIsL28pAP0XhxlJk6'
...
def doctor_dashboard():
    ...
    # Fetch medical records for patients treated by the logged-in doctor
    cursor.execute('''
        SELECT mr.*, u.screen_name AS patient_name
